/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 893c6bf90a7f42b284f5b78ca458c584)
// Runtime types generated with workerd@1.20260317.1 2025-08-03
declare namespace Cloudflare {
	...
	interface Env {
		...
		SCM_BRANCH_CREATED_Q: Queue;
		SCM_BRANCH_DELETED_Q: Queue;
		SCM_CHANGE_CREATED_Q: Queue;
		SCM_CHANGE_REVIEWED_Q: Queue;
		SCM_CHANGE_MERGED_Q: Queue;
		SCM_CHANGE_ABANDONED_Q: Queue;
		CI_BUILD_QUEUED_Q: Queue;
		CI_BUILD_STARTED_Q: Queue;
		CI_BUILD_FINISHED_Q: Queue;
		TICKET_CREATED_Q: Queue;
		TICKET_UPDATED_Q: Queue;
		TICKET_CLOSED_Q: Queue;
	}
}
