...
export const GitHubWorkflowJobStepSchema = z
  .object({
    name: z.string(),
...
export const GitHubWorkflowJobQueuedWebhookSchema =
  GitHubWorkflowJobWebhookSchema.extend({
    action: z.literal('queued'),
  }).openapi('GitHubWorkflowJobQueuedWebhook', {
    description: 'GitHub workflow job queued webhook payload',
  });

export const GitHubWorkflowJobWaitingWebhookSchema =
  GitHubWorkflowJobWebhookSchema.extend({
...
export const GitHubWorkflowJobInProgressWebhookSchema =
  GitHubWorkflowJobWebhookSchema.extend({
...
export const GitHubWorkflowJobCompletedWebhookSchema =
  GitHubWorkflowJobWebhookSchema.extend({
...
export const GitHubPingWebhookSchema = z
  .object({
  ...
  .openapi('GitHubPingWebhook', {
    description:
      'GitHub ping webhook payload sent when a webhook is first created',
  });
...
export type GitHubWorkflowJobWebhook = z.infer<
  typeof GitHubWorkflowJobWebhookSchema
>;
export type GitHubWorkflowJobQueuedWebhook = z.infer<
  typeof GitHubWorkflowJobQueuedWebhookSchema
>;
export type GitHubWorkflowJobWaitingWebhook = z.infer<
  typeof GitHubWorkflowJobWaitingWebhookSchema
>;
export type GitHubWorkflowJobInProgressWebhook = z.infer<
  typeof GitHubWorkflowJobInProgressWebhookSchema
>;
export type GitHubWorkflowJobCompletedWebhook = z.infer<
  typeof GitHubWorkflowJobCompletedWebhookSchema
>;
