...
describe('GitHubAdapter', () => {
    ...
    it('should validate actual GitHub webhook payload structure', async () => {
      const actualWebhookPayload = {
        ...
        workflow_job: {
          ...
          head_branch: 'master',
          run_url:
            'https://api.github.com/repos/brucellino/personal-automation/actions/runs/17454675960',
          run_attempt: 1,
          ...
          html_url:
            'https://github.com/brucellino/personal-automation/actions/runs/17454675960/job/49565775813',
          status: 'queued',
          conclusion: null,
          ...
          steps: [],
          check_run_url:
            'https://api.github.com/repos/brucellino/personal-automation/check-runs/49565775813',
        ...
        repository: {
          ...
          owner: {
            ...
            following_url:
              'https://api.github.com/users/brucellino/following{/other_user}',
            gists_url:
              'https://api.github.com/users/brucellino/gists{/gist_id}',
            starred_url:
              'https://api.github.com/users/brucellino/starred{/owner}{/repo}',
            subscriptions_url:
              'https://api.github.com/users/brucellino/subscriptions',
            organizations_url: 'https://api.github.com/users/brucellino/orgs',
            repos_url: 'https://api.github.com/users/brucellino/repos',
            events_url:
              'https://api.github.com/users/brucellino/events{/privacy}',
            received_events_url:
              'https://api.github.com/users/brucellino/received_events',
            type: 'User',
          ...
          archive_url:
            'https://api.github.com/repos/brucellino/personal-automation/{archive_format}{/ref}',
          assignees_url:
            'https://api.github.com/repos/brucellino/personal-automation/assignees{/user}',
          blobs_url:
            'https://api.github.com/repos/brucellino/personal-automation/git/blobs{/sha}',
          branches_url:
            'https://api.github.com/repos/brucellino/personal-automation/branches{/branch}',
          collaborators_url:
            'https://api.github.com/repos/brucellino/personal-automation/collaborators{/collaborator}',
          comments_url:
            'https://api.github.com/repos/brucellino/personal-automation/comments{/number}',
          commits_url:
            'https://api.github.com/repos/brucellino/personal-automation/commits{/sha}',
          compare_url:
            'https://api.github.com/repos/brucellino/personal-automation/compare/{base}...{head}',
          contents_url:
            'https://api.github.com/repos/brucellino/personal-automation/contents/{+path}',
          contributors_url:
            'https://api.github.com/repos/brucellino/personal-automation/contributors',
          deployments_url:
            'https://api.github.com/repos/brucellino/personal-automation/deployments',
          downloads_url:
            'https://api.github.com/repos/brucellino/personal-automation/downloads',
          events_url:
            'https://api.github.com/repos/brucellino/personal-automation/events',
          forks_url:
            'https://api.github.com/repos/brucellino/personal-automation/forks',
          git_commits_url:
            'https://api.github.com/repos/brucellino/personal-automation/git/commits{/sha}',
          git_refs_url:
            'https://api.github.com/repos/brucellino/personal-automation/git/refs{/sha}',
          git_tags_url:
            'https://api.github.com/repos/brucellino/personal-automation/git/tags{/sha}',
          git_url: 'git://github.com/brucellino/personal-automation.git',
          issue_comment_url:
            'https://api.github.com/repos/brucellino/personal-automation/issues/comments{/number}',
          issue_events_url:
            'https://api.github.com/repos/brucellino/personal-automation/issues/events{/number}',
          issues_url:
            'https://api.github.com/repos/brucellino/personal-automation/issues{/number}',
          keys_url:
            'https://api.github.com/repos/brucellino/personal-automation/keys{/key_id}',
          labels_url:
            'https://api.github.com/repos/brucellino/personal-automation/labels{/name}',
          languages_url:
            'https://api.github.com/repos/brucellino/personal-automation/languages',
          merges_url:
            'https://api.github.com/repos/brucellino/personal-automation/merges',
          milestones_url:
            'https://api.github.com/repos/brucellino/personal-automation/milestones{/number}',
          notifications_url:
            'https://api.github.com/repos/brucellino/personal-automation/notifications{?since,all,participating}',
          pulls_url:
            'https://api.github.com/repos/brucellino/personal-automation/pulls{/number}',
          releases_url:
            'https://api.github.com/repos/brucellino/personal-automation/releases{/id}',
  ...
  describe('Workflow Job Queued Transformation', () => {
    ...
    it('should include GitHub-specific custom data', async () => {
      ...
      expect(result.customData.github.workflow_job.workflow_name).toBe(
        'CI/CD Pipeline'
      );
    ...
    it('should handle ping event in unsupported check', async () => {
      const pingWebhook = {
        ...
        hook: {
          ...
          created_at: '2023-10-01T11:00:00Z',
          deliveries_url:
            'https://api.github.com/repos/owner/test-repo/hooks/123/deliveries',
          ping_url:
            'https://api.github.com/repos/owner/test-repo/hooks/123/pings',
          last_response: null,
        },
        repository: mockRepository,
        sender: mockSender,
